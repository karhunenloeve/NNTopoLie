...
\hypersetup{
    pdftitle={Parametrization of Neural Networks with Connected Abelian Lie Groups as Data Manifold},    % title
    pdfauthor={Luciano Melodia},     % author
    pdfsubject={Neural Networks on Connected Abelian Lie Groups},   % subject of the document
...
%
\titlerunning{Neural Networks on Connected Abelian Lie Groups}
